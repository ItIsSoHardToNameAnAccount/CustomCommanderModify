...
skills = [
  ...
  ("cooking","Cooking",sf_base_att_int|sf_effects_party,10,"Every level of this skill increases the food bonus to party morale by 10%%, reduces the consumption of foods by 3%%. (Party skill) Max level: 10"), 
