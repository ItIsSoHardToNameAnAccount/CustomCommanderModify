...
## CC
  ...
  ("camp",mnf_scale_picture,
   ...
   [
    ...
    # ("camp_testing_presentation",[],"{!}Testing presentation.", 
    # [
      # (start_presentation, "prsnt_testing_presentation"),
     # ]),
   ...
   [
    ...
    [
      ...
      #("camp_cheat_find_item",[], "Change weather..",
       ...
       #),	   
	   ## CC
      ("camp_cheat_cc_1",[],"Increase player gold.",
       [
         (call_script, "script_troop_add_gold", "trp_player", 50000),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
      ("camp_cheat_cc_2",[],"Add xp to your party.",
       [
         (party_add_xp, "p_main_party", 50000),
         (display_message, "@Your party get 50000 experience points."),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
     ...
     ## CC
      ...
      ("cheat_faction_orders_to_all",[(ge,"$cheat_mode",1)],
	  "Cheat: Set Debug messages to All.",
       [(assign,"$cheat_mode",1),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
      ("cheat_faction_orders_to_econ",[
	  (ge, "$cheat_mode", 1),
      ...
      ("cheat_faction_orders_to_political",[
	  (ge, "$cheat_mode", 1),
        ...
        (else_try),                 
          ...
          (try_begin),
            ...
            (try_for_range_backwards, ":stack_no", 0, ":num_stacks"),
              ...
              (this_or_next|eq, ":stack_troop_faction", "fac_outlaws"),
              (eq, ":stack_troop_faction", "fac_dark_followers"),
  ...
  (
    ...
    [#(assign, ":num_improvements", 0),
     ...
     # (try_begin),
       ...
       # (str_store_string, s19, "@{s19}^You can lay some money to this {s17} for recruiting troops of {s2} automatically. You have {reg1} denars left here(can recruit for {reg2} {reg3?times:time}) and have {reg5} denars in your package."),
     # (try_end),
...
## CC gambling end
             ...
             (try_for_range, ":cur_travelling_horse_merchant", travelling_horse_merchants_begin, travelling_horse_merchants_end),
               (troop_get_slot, ":leaded_party", ":cur_travelling_horse_merchant", slot_troop_leaded_party),
               (party_is_in_town, ":leaded_party", "$current_town"),
               (set_visitor, ":cur_entry", ":cur_travelling_horse_merchant"),
               (val_add, ":cur_entry", 1),
             (try_end),
             ## CC
...
#			(troop_slot_eq, ":lady_guardian", slot_lord_granted_courtship_permission, -1),
    ...
    ## CC
      ("castle_recruit",
      [
        (party_get_slot, ":reserves_party", "$current_town", slot_center_reserves_party),
        (gt, ":reserves_party", 0),
        (party_get_num_companions, ":num_men", ":reserves_party"),
        (gt, ":num_men", 0),
      ],
      "Recruit troops.",
      [
        (start_presentation, "prsnt_recruit_from_reserves_party"),
      ]),
    ## CC
...
## CC
 ...
 This will surely be your best opportunity to attack him.",
  ...
  ("start_phase_3",mnf_disable_all_keys,
    ...
    [
      ## CC
      ("skip",[], "Skip this plot, and quick start the game.",
       [         
         (assign, "$g_starting_town", "$current_town"),
         ...
         (try_for_range, ":npc_no", companions_begin, companions_end),
           (call_script, "script_recruit_troop_as_companion", ":npc_no"),
           (troop_set_slot, ":npc_no", slot_troop_first_encountered, "$g_starting_town"),
           (troop_set_slot, ":npc_no", slot_troop_met, 1),
         ...
         (display_message, "@Your party get 100000 experience points."),
         ## add some troops to player's party
         (store_faction_of_party, ":party_faction", "$g_starting_town"),
         (faction_get_slot, ":party_template_c", ":party_faction", slot_faction_reinforcements_c_hero),
