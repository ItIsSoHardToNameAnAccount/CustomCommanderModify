...
# Items before this point are hardwired and their order should not be changed!
 ...
 ["practice_staff","Practice Staff", [("wooden_staff",0)],itp_type_polearm|itp_offset_lance|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack,itc_shortened_spear|itcf_carry_sword_back,9, weight(2.5)|spd_rtng(103) | weapon_length(118)|swing_damage(18,blunt) | thrust_damage(18,blunt),imodbits_none],
...
##                                                     ("hunting_bow",0)],                  itp_type_bow|itp_two_handed|itp_primary|itp_attach_left_hand, itcf_shoot_bow, 4,weight(1.5)|spd_rtng(90)|shoot_speed(40)|thrust_damage(19,blunt),imodbits_none],
 ...
 ["practice_javelin_melee", "practice_javelin_melee", [("javelin",0),("javelins_quiver", ixmesh_carry)], itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry , itc_shortened_spear, 0, weight(1)|difficulty(0)|spd_rtng(91) |swing_damage(12, blunt)| thrust_damage(14,  blunt)|weapon_length(75),imodbits_polearm ],
 ## CC
...
["arena_shield_pavise_y", "Shield",   [("arena_shield_pavise_Y",0)], itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_board_shield, 60 , weight(3.5)|hit_points(280)|body_armor(2)|spd_rtng(89)|shield_width(43)|shield_height(100),imodbits_shield],
 ...
 ["practice_javelin_r_melee", "practice_javelin_melee", [("javelin",0),("javelins_quiver_R", ixmesh_carry)], itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry , itc_shortened_spear, 0, weight(1)|difficulty(0)|spd_rtng(91) |swing_damage(12, blunt)| thrust_damage(14,  blunt)|weapon_length(75),imodbits_polearm ],
 ...
 ["practice_javelin_b_melee", "practice_javelin_melee", [("javelin",0),("javelins_quiver_B", ixmesh_carry)], itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry , itc_shortened_spear, 0, weight(1)|difficulty(0)|spd_rtng(91) |swing_damage(12, blunt)| thrust_damage(14,  blunt)|weapon_length(75),imodbits_polearm ],
 ...
 ["practice_javelin_g_melee", "practice_javelin_melee", [("javelin",0),("javelins_quiver_G", ixmesh_carry)], itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry , itc_shortened_spear, 0, weight(1)|difficulty(0)|spd_rtng(91) |swing_damage(12, blunt)| thrust_damage(14,  blunt)|weapon_length(75),imodbits_polearm ],
 ...
 ["practice_javelin_y_melee", "practice_javelin_melee", [("javelin",0),("javelins_quiver_Y", ixmesh_carry)], itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry , itc_shortened_spear, 0, weight(1)|difficulty(0)|spd_rtng(91) |swing_damage(12, blunt)| thrust_damage(14,  blunt)|weapon_length(75),imodbits_polearm ],
...
# double the amount of other food
 ["smoked_fish","Smoked Fish", [("smoked_fish",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 130,weight(30)|abundance(110)|food_quality(6)|max_ammo(100),imodbits_none],
 ["cheese","Cheese", [("cheese_b",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 150,weight(12)|abundance(110)|food_quality(8)|max_ammo(60),imodbits_none],
 ["honey","Honey", [("honey_pot",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 440,weight(10)|abundance(110)|food_quality(9)|max_ammo(60),imodbits_none],
 ["sausages","Sausages", [("sausages",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 170,weight(20)|abundance(110)|food_quality(8)|max_ammo(80),imodbits_none],
 ["cabbages","Cabbages", [("cabbage",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 60,weight(30)|abundance(110)|food_quality(4)|max_ammo(100),imodbits_none],
 ["dried_meat","Dried Meat", [("smoked_meat",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 170,weight(30)|abundance(100)|food_quality(8)|max_ammo(100),imodbits_none],
 ["apples","Fruit", [("apple_basket",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 88,weight(40)|abundance(110)|food_quality(6)|max_ammo(100),imodbits_none],
 ["raw_grapes","Grapes", [("grapes_inventory",0)], itp_merchandise|itp_consumable|itp_type_goods, 0, 300,weight(40)|abundance(90)|food_quality(5)|max_ammo(40),imodbits_none], #x2 for wine
 ["raw_olives","Olives", [("olive_inventory",0)], itp_merchandise|itp_consumable|itp_type_goods, 0, 400,weight(40)|abundance(90)|food_quality(2)|max_ammo(40),imodbits_none], #x3 for oil
 ["grain","Grain", [("wheat_sack",0)], itp_merchandise|itp_type_goods|itp_consumable, 0, 60,weight(60)|abundance(110)|food_quality(3)|max_ammo(100),imodbits_none],
 ["raw_date_fruit","Date Fruit", [("date_inventory",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 480,weight(16)|food_quality(6)|max_ammo(40),imodbits_none], 
 ...
 ["bread","Bread", [("bread_a",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 100,weight(60)|abundance(110)|food_quality(12)|max_ammo(100),imodbits_none],
 ...
 ["butter","Butter", [("butter_pot",0)], itp_merchandise|itp_type_goods|itp_consumable|itp_food, 0, 300,weight(12)|abundance(110)|food_quality(6)|max_ammo(60),imodbits_none],
## CC
...
## CC
 ["hunter_black","Black Hunter", [("hunting_horse_black",0),("hunting_horse_black",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 810,abundance(60)|hit_points(160)|body_armor(18)|difficulty(3)|horse_speed(43)|horse_maneuver(44)|horse_charge(24)|horse_scale(108),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_1, fac_kingdom_2]],
## CC
 ...
 ["warhorse_d","War Horse", [("warhorse_chain_D",0)], itp_type_horse, 0, 1224,abundance(50)|hit_points(165)|body_armor(40)|difficulty(4)|horse_speed(40)|horse_maneuver(41)|horse_charge(28)|horse_scale(110),imodbits_horse_basic|imodbit_champion, [], [],],
...
["warhorse_e","Scale Draped Warhorse", [("warhorse_e",0)], itp_merchandise|itp_type_horse, 0, 1500,abundance(50)|hit_points(165)|body_armor(45)|difficulty(4)|horse_speed(40)|horse_maneuver(41)|horse_charge(30)|horse_scale(110),imodbits_horse_basic|imodbit_champion],
 ...
 ["heavy_hunter_black","Heavy Black Hunter", [("hunting_horse_black",0),("hunting_horse_black",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 1539,abundance(60)|hit_points(170)|body_armor(21)|difficulty(3)|horse_speed(43)|horse_maneuver(44)|horse_charge(28)|horse_scale(118),imodbits_horse_basic|imodbit_champion, [], [fac_kingdom_1, fac_kingdom_2]],
 ...
 ["heavy_warhorse_d","Heavy War Horse", [("warhorse_chain_D",0)], itp_type_horse, 0, 2325,abundance(50)|hit_points(175)|body_armor(43)|difficulty(4)|horse_speed(40)|horse_maneuver(41)|horse_charge(32)|horse_scale(120),imodbits_horse_basic|imodbit_champion],
...
## CC
["arena_armor_black", "Arena Armor Black", [("arena_armorBlack",0)], itp_type_body_armor  |itp_covers_legs ,0, 650 , weight(16)|abundance(100)|head_armor(0)|body_armor(29)|leg_armor(13), imodbits_armor ],
["mail_shirt_black", "Mail Shirt Black", [("mail_shirt_black",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1040 , weight(19)|abundance(100)|head_armor(0)|body_armor(37)|leg_armor(12)|difficulty(7) ,imodbits_armor ],
["mail_with_surcoat_black", "Mail with Surcoat Black", [("mail_long_surcoat_black",0)], itp_merchandise| itp_type_body_armor  |itp_covers_legs ,0,
 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor ],
## CC
...
## CC
 ...
 200 , weight(8)|difficulty(10)|spd_rtng(78) | weapon_length(124)|swing_damage(33 , blunt) | thrust_damage(23 , blunt),imodbits_mace ],
 ...
 210 , weight(9)|difficulty(11)|spd_rtng(75) | weapon_length(127)|swing_damage(35, blunt) | thrust_damage(24 , blunt),imodbits_mace ],
 ...
 600 , weight(11)|difficulty(13)|spd_rtng(73) | weapon_length(120)|swing_damage(40 , blunt) | thrust_damage(27 , blunt),imodbits_mace ],
## CC
...
## CC
["military_fork", "Military Fork", [("military_fork",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry,itc_shortened_spear, 153 , weight(2)|difficulty(0)|spd_rtng(95) | weapon_length(135)|swing_damage(15 , blunt) | thrust_damage(30 ,  pierce),imodbits_polearm ], 
["battle_fork",         "Battle Fork", [("battle_fork",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry,itc_shortened_spear, 282 , weight(2.2)|difficulty(0)|spd_rtng(90) | weapon_length(144)|swing_damage(15, blunt) | thrust_damage(35 ,  pierce),imodbits_polearm ],
## CC
...
["double_sided_lance", "Double Sided Lance", [("lance_dblhead",0)], itp_couchable|itp_crush_through|itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_shortened_spear, 261 , weight(4.0)|difficulty(0)|spd_rtng(95) | weapon_length(128)|swing_damage(25, cut) | thrust_damage(27 ,  pierce),imodbits_polearm ], ## CC
...
["polehammer",         "Polehammer", [("pole_hammer",0)], itp_type_polearm|itp_offset_lance| itp_primary|itp_two_handed|itp_wooden_parry|itp_crush_through|itp_can_knock_down, itc_staff,
 ...
 ## CC
["staff",         "Staff", [("wooden_staff",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack, itc_shortened_spear|itcf_carry_sword_back,
 36 , weight(1.5)|difficulty(0)|spd_rtng(100) | weapon_length(130)|swing_damage(18 , blunt) | thrust_damage(19 ,  blunt),imodbits_polearm ], 
["quarter_staff", "Quarter Staff", [("quarter_staff",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry|itp_wooden_attack, itc_shortened_spear|itcf_carry_sword_back,
...
["iron_staff",         "Iron Staff", [("iron_staff",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary, itc_staff|itcf_carry_sword_back,
 202 , weight(4)|difficulty(0)|spd_rtng(97) | weapon_length(140)|swing_damage(25 , blunt) | thrust_damage(26 ,  blunt),imodbits_polearm ],
...
## CC
["shortened_spear",         "Shortened Spear", [("spear_g_1-9m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_shortened_spear|itcf_carry_spear,
 53 , weight(2.0)|difficulty(0)|spd_rtng(102) | weapon_length(120)|swing_damage(19 , blunt) | thrust_damage(25 ,  pierce),imodbits_polearm ], 
["spear",         "Spear", [("spear_h_2-15m",0)], itp_type_polearm|itp_offset_lance|itp_merchandise| itp_primary|itp_wooden_parry, itc_shortened_spear|itcf_carry_spear,
...
##
["bull_great_helmet", "Bull Great Helmet", [("maciejowski_helmet_new_2",0)], itp_merchandise|itp_type_head_armor|itp_covers_head,0, 1240 , weight(2.75)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
...
["icon_half_width_array", "{!}Kite Shield", [("norman_shield_2",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["temp_array_a",  "{!}Kite Shield", [("norman_shield_3",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["temp_array_b",  "{!}Kite Shield", [("norman_shield_4",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["temp_array_c",  "{!}Kite Shield", [("norman_shield_5",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|shield_width(90),imodbits_shield ],
["temp_array_d",  "{!}Kite Shield", [("norman_shield_6",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|shield_width(90),imodbits_shield ],
##
...
## CC
["hunting_bow",         "Hunting Bow", [("hunting_bow",0),("hunting_bow_carry",ixmesh_carry)],itp_type_bow|itp_two_handed |itp_merchandise|itp_primary,itcf_shoot_bow|itcf_carry_bow_back, 
17 , weight(1)|difficulty(0)|spd_rtng(100) | shoot_speed(52) | thrust_damage(15 ,  pierce),imodbits_bow ],
["short_bow",         "Short Bow", [("short_bow",0),("short_bow_carry",ixmesh_carry)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
58 , weight(1)|difficulty(1)|spd_rtng(97) | shoot_speed(55) | thrust_damage(18 ,  pierce)|accuracy(96),imodbits_bow ],
["nomad_bow",         "Nomad Bow", [("nomad_bow",0),("nomad_bow_case", ixmesh_carry),("nomad_bow_inventory", ixmesh_inventory)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn, 
164 , weight(1.25)|difficulty(2)|spd_rtng(94) | shoot_speed(56) | thrust_damage(20 ,  pierce)|accuracy(94),imodbits_bow ],
["long_bow",         "Long Bow", [("long_bow",0),("long_bow_carry",ixmesh_carry)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
145 , weight(1.75)|difficulty(3)|spd_rtng(79) | shoot_speed(56) | thrust_damage(22 ,  pierce)|accuracy(92),imodbits_bow, [], [fac_kingdom_4]],
["khergit_bow",         "Khergit Bow", [("khergit_bow",0),("khergit_bow_case", ixmesh_carry),("khergit_bow_inventory", ixmesh_inventory)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn, 
269 , weight(1.25)|difficulty(3)|spd_rtng(90) | shoot_speed(57) | thrust_damage(21 ,pierce)|accuracy(93),imodbits_bow, [], [fac_kingdom_3]],
["triangle_bow",  "Triangle Bow", [("triangle_bow",0),("triangle_bow_carray", ixmesh_carry)], itp_type_bow|itp_two_handed|itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
150, weight(1.25)|difficulty(2)|spd_rtng(96) | shoot_speed(55) | thrust_damage(19,  pierce)|accuracy(95),imodbits_bow ],
["sarranid_bow",      "Sarranid Bow", [("new_strong_bow",0),("new_strong_bow_carry", ixmesh_carry)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
375 , weight(1.25)|difficulty(4)|spd_rtng(89) | shoot_speed(57) | thrust_damage(22 ,pierce)|accuracy(92),imodbits_bow, [], [fac_kingdom_6]],
["strong_bow",         "Strong Bow", [("strong_bow",0),("strong_bow_case", ixmesh_carry),("strong_bow_inventory", ixmesh_inventory)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn, 
...
["war_bow",         "War Bow", [("war_bow",0),("war_bow_carry",ixmesh_carry)],itp_type_bow|itp_two_handed|itp_merchandise|itp_primary, itcf_shoot_bow|itcf_carry_bow_back, 
728 , weight(1.5)|difficulty(5)|spd_rtng(84) | shoot_speed(59) | thrust_damage(25 ,pierce)|accuracy(89),imodbits_bow, [], [fac_kingdom_2]],
["steel_long_bow",    "Steel Bow", [("steel_long_bow",0),("steel_long_bow_carry",ixmesh_carry)], itp_type_bow|itp_two_handed |itp_primary|itp_bonus_against_shield|itp_extra_penetration, itcf_shoot_bow|itcf_carry_bow_back, 
1250 , weight(3)|difficulty(5)|spd_rtng(82) | shoot_speed(70) | thrust_damage(27,  pierce)|accuracy(90),imodbits_bow ],

["strong_hunting_bow",         "Strong Hunting Bow", [("hunting_bow",0),("hunting_bow_carry",ixmesh_carry)],itp_type_bow|itp_two_handed |itp_merchandise|itp_primary,itcf_shoot_bow|itcf_carry_bow_back, 
83 , weight(1)|difficulty(0)|spd_rtng(97) | shoot_speed(52) | thrust_damage(18 ,  pierce),imodbits_bow ],
["strong_short_bow",         "Strong Short Bow", [("short_bow",0),("short_bow_carry",ixmesh_carry)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
284 , weight(1)|difficulty(3)|spd_rtng(94) | shoot_speed(55) | thrust_damage(21 ,  pierce)|accuracy(96),imodbits_bow ],
["strong_nomad_bow",         "Strong Nomad Bow", [("nomad_bow",0),("nomad_bow_case", ixmesh_carry),("nomad_bow_inventory", ixmesh_inventory)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn, 
803 , weight(1.25)|difficulty(4)|spd_rtng(91) | shoot_speed(56) | thrust_damage(23 ,  pierce)|accuracy(94),imodbits_bow ],
["strong_long_bow",         "Strong Long Bow", [("long_bow",0),("long_bow_carry",ixmesh_carry)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
710 , weight(1.75)|difficulty(5)|spd_rtng(76) | shoot_speed(56) | thrust_damage(25 ,  pierce)|accuracy(92),imodbits_bow, [], [fac_kingdom_4]],
["strong_khergit_bow",         "Strong Khergit Bow", [("khergit_bow",0),("khergit_bow_case", ixmesh_carry),("khergit_bow_inventory", ixmesh_inventory)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn, 
1318 , weight(1.25)|difficulty(5)|spd_rtng(87) | shoot_speed(57) | thrust_damage(24 ,pierce)|accuracy(93),imodbits_bow, [], [fac_kingdom_3]],
["strong_triangle_bow",  "Strong Triangle Bow", [("triangle_bow",0),("triangle_bow_carray", ixmesh_carry)], itp_type_bow|itp_two_handed|itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
735, weight(1.25)|difficulty(4)|spd_rtng(93) | shoot_speed(55) | thrust_damage(22,  pierce)|accuracy(95),imodbits_bow ],
["strong_sarranid_bow",      "Strong Sarranid Bow", [("new_strong_bow",0),("new_strong_bow_carry", ixmesh_carry)], itp_type_bow|itp_two_handed |itp_merchandise|itp_primary ,itcf_shoot_bow|itcf_carry_bow_back, 
1837 , weight(1.25)|difficulty(6)|spd_rtng(86) | shoot_speed(57) | thrust_damage(25 ,pierce)|accuracy(92),imodbits_bow, [], [fac_kingdom_6]],
["strong_war_bow",         "Strong War Bow", [("war_bow",0),("war_bow_carry",ixmesh_carry)],itp_type_bow|itp_two_handed|itp_merchandise|itp_primary, itcf_shoot_bow|itcf_carry_bow_back, 
3567 , weight(1.5)|difficulty(7)|spd_rtng(81) | shoot_speed(59) | thrust_damage(28 ,pierce)|accuracy(89),imodbits_bow, [], [fac_kingdom_2]],
["strong_steel_long_bow",    "Strong Steel Bow", [("steel_long_bow",0),("steel_long_bow_carry",ixmesh_carry)], itp_type_bow|itp_two_handed |itp_primary|itp_bonus_against_shield|itp_extra_penetration, itcf_shoot_bow|itcf_carry_bow_back, 
